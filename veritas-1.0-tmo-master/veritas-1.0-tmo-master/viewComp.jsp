...
function editRecord(id){
  ...
  function viewNote(id){
	    ...
	    window.location.href="viewCompImpact/"+id; 
	  }
  function addNote(id){
...
.dropdown:hover .dropdown-content {
 ...
 <br>
<div align="center" style="font-size:280%; color:#E20074; font-family: Arial;"; > Component List </div><div><input type="button" id="btnExport" onclick="Export('Veritas_Project_Application.xls')" style="background-color:#ff7faf;font-weight:bold;color:#ffffff;" value="Export to Excel"></div>
	...
	if(request.getAttribute("projectList")!=null && request.getAttribute("projectList")!="")
	{
		...
		while(itr.hasNext())
		{
			...
			%>
				...
				<td><input type="button" name="view" value="View all Impact" style="background-color:#ff7faf;font-weight:bold;color:#ffffff;" onclick="viewNote(<%=id%>);" ></td>
