...
public class ViewPDR extends HttpServlet{ 
	   			...
	   			try {
	   				...
	   				while(rs.next())
	   				{
	   					project.put(rs.getString(1), rs.getString(2));
	   						   ...
	   						   String query8="select * from projectmanagementservice.projectdeleiveryrisk  order by projectID desc";
	   	             ...
	   	             // session.setAttribute("helloWorld", "Hello world");
	   	                ...
	   	                session.setAttribute("pdr",techDebt);
	   			
	   				
	                   String nextJSP = "/Veritas/AllpdrUI/";
	   				conn.close();
