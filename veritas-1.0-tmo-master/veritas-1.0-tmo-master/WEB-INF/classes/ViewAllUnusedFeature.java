...
public class ViewAllUnusedFeature extends HttpServlet{ 
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			try {
				...
				ArrayList projectList =new ArrayList();
					 ...
					 request.setAttribute("UnusedfeatureList", projectList);
					 System.out.println("<>>>>>>>>>>>>>>>"+2);
					 request.setAttribute("message","");
					 System.out.println("<>>>>>>>>>>>>>>>"+3);
		                 nextJSP = "/allUnusedFeature/";
...
private ArrayList getAllHLSD(Connection conn) {
	...
	try{
		String query = "select * from feature where projectID=0";
