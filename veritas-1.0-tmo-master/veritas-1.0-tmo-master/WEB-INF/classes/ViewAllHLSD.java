...
public class ViewAllHLSD extends HttpServlet{ 
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			try {
				...
				String countStatus=" select ReviewStatus,count(*) from projectmanagementservice.hlsd  where reviewstype !='Assessment Review' or reviewstype is null group by ReviewStatus";
				...
				String countStatus1="select impact,count(*) from projectmanagementservice.feedback where reviewstype !='Assessment Review' or impact is null group by impact";
				
				Statement st5 = conn.createStatement();
				ResultSet  rs5 = st5.executeQuery(countStatus1);
				Map<Object,Object> map1= null;
				List<Map<Object,Object>> hlsdReview = new ArrayList<Map<Object,Object>>();
				...
				while(rs5.next())
				{
					...
					hlsdReview.add(map1);
					 ...
					 request.setAttribute("hlsdStatus", hlsdStatus);
					 request.setAttribute("AssesmentStatus", hlsdReview);
...
private ArrayList getAllHLSD(Connection conn) {
	...
	try{
		...
		while(rs1.next())
		{
			 ...
			 * 
			 * 
			 * String query = "select * from hlsd"; System.out.println("query " + query);
			 * Statement st1 = conn.createStatement(); ResultSet rs =
			 ...
			 * 
			 * 
			 * while(rs.next()) { p1 = new ArrayList(); p1.add(rs.getString(1));
			 * p1.add(project.get(rs.getString(1)));
			 * 
			 * if(rs.getString(21)!=null) {
			 * if(rs.getString(21).trim().equalsIgnoreCase("null")) { p1.add("HLSD"); }else
			 * { p1.add(rs.getString(21).split(" ")[0]); } }else { p1.add("HLSD"); }
			 * 
			 * 
			 * 
			 * 
			 * p1.add(rs.getString(2)); p1.add(rs.getString(3)); p1.add(rs.getString(4));
			 * p1.add(rs.getString(5)); //p1.add(rs.getString(6));
			 * //p1.add(rs.getString(7)); //p1.add(rs.getString(8));
			 * p1.add(rs.getString(9)); // p1.add(rs.getString(10));
		...
		String query = "select a.reviewstype,a.projectid,b.ProjectNumber,b.ProjectTitle,a.comment,a.priority,a.notes from projectmanagementservice.feedback"
				+ " a join projectmanagementservice.project b on a.projectid=b.projectid";
