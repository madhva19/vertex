...
public class viewAllIntegration extends HttpServlet{ 
			...
			try {
				...
				while(rs.next())
				{
					project.put(rs.getString(1), rs.getString(2));
						   ...
						   String query8="select * from projectmanagementservice.projectitddetails  order by projectID desc";
                ...
                String nextJSP = "/Veritas/viewAllIT/";
				conn.close();
