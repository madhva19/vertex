...
String url = Messages.getString("connectionURL"); 
		...
		//	out.println(request.getRequestURI());
			...
			try {
				...
				String query = "select workstream,count(*) from projectmanagementservice.project group by workstream";
				...
				while(rs2.next())
				{
					...
					map.put("label", rs2.getString(1)); 
					map.put("y",Integer.parseInt(rs2.getString(2)));
					workStream.add(map);
				}
