...
<ul class="breadcrumb" style="background-color:white;">
  ...
  <li><a href="#" style="color:black;">Metrics Dashboard</a></li>
  
</ul>
<div align="center" style="font-size:280%; color:#E20074; font-family: Arial; " > Metrics Dashboard </div> 
...
<tr style="border:2px double #E20074;border-style:  solid double;height:40px;" >
 ...
 <th  align="left" width=6% onclick="SortTable(0,'N')">Review Id </th>
 ...
 <th align="left" width=15% onclick="SortTable(3,'T')">Project Category </th>
  <th align="left" width=15% onclick="SortTable(4,'T')">Project Type</th>
