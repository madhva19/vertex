...
function isNumberKey(evt)
    ...
    var fn=document.getElementsByName('FeatureCode')[0].value;
    if(fn == ""){
		 swal("Error!","Please Enter Feature Code", "error");
     
        document.getElementsByName('FeatureCode')[0].style.borderColor = "red";
        return false;
    }else{
        document.getElementsByName('FeatureCode')[0].style.borderColor = "green";
    }
  
  
	
	 if(document.getElementsByName('FeatureDescription')[0].value == ""){
		 swal("Error!","Please Enter Feature Description", "error");
     
        document.getElementsByName('FeatureDescription')[0].style.borderColor = "red";
        return false;
    }else{
        document.getElementsByName('FeatureDescription')[0].style.borderColor = "green";
    }
	  }  
...
<div align="center" style="font-size:280%; color:#FF0099"; > Add Feature </div>


<form name="userform" method="get" action="/Veritas/AddFeature" onsubmit="return FormValidation();" onchange="return FormValidation();">
<br><br><br>
<table align="center" width="1000px" style="border:2px double #FF0099;border-style:  solid double;">
	...
	<tr>
		...
		<td style="font-weight:bold;">Dependent Feature :(Number Only) <input type="text" name="DependentFeature" onkeypress="return isNumberKey(event)"  value=""></td>
	...
	<tr><td colspan=2 align="center" height="10px"><input type=hidden name="action" Value="addFeatureWithoutProject"></td></tr>
</table>
