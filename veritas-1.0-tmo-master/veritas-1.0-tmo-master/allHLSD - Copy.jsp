 ...
 <HEAD>
  ...
  window.onload = function() { 
	  ...
	  var chart8 = new CanvasJS.Chart("chartContainer_Workstream1", {
	 	...
	 	exportFileName: "HLSD review count",
	 	exportEnabled: true,
	 	title:{
	 		text: "HLSD review count",
	 			fontColor: "#E20074",
		 		fontFamily: "Arial",
		 		//fontStyle: "oblique",
	 			fontSize: 25
	  ...
	  var chart9 = new CanvasJS.Chart("chartContainer_Workstream2", {
		 	theme: "light2",
		 	animationEnabled: true,
		 	exportFileName: "Assessment review count",
		 	exportEnabled: true,
		 	title:{
		 		text: " Assessment review count",
		 		fontColor: "#E20074",
		 		fontFamily: "Arial",
		 		//fontStyle: "oblique",
	 			fontSize: 25
...
<thead>
  ...
  <input type="text" id='txt_searchall'  placeholder="Search by Project ID/Number or Project Title " >
	...
	<td><i class="fa fa-file-excel-o fa-2x" aria-hidden="true" title="Export to Excel" onclick="Export('Veritas_Projectreview_Export.xls')"></i></td>
 ...
 <th width=6%  onclick="SortTable(0,'N');">Project ID </th>
  <th width=8% onclick="SortTable(1,'T');">Project Title </th>
  
   <th width=6% onclick="SortTable(2,'T');">Review Type </th>
  <th width=6% onclick="SortTable(2,'D','ymd');">Review Date </th>
  <th width=6% onclick="SortTable(3,'T');">HLSD TShirt </th>
 <th width=7% onclick="SortTable(4,'T');">Review Status </th>
  <th width=6%  onclick="SortTable(5,'N')">Action Items </th>

    <th width=6% onclick="SortTable(9,'N')">API Count </th>

  <th onclick="SortTable(11,'T');">Executive Summary </th>
	...
	if(request.getAttribute("hlsdList")!=null && request.getAttribute("hlsdList")!="")
	{
		...
		while(itr.hasNext())
		{
			...
			%>
				...
				<td><input type="button" name="view" value="View Project" style="background-color: #E20074;border-radius: 50px;width:90px;height:30px;color:#ffffff;" onclick="viewNote(<%=id%>);" ></td>
